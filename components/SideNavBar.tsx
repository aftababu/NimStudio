    ...
    >
      ...
      <div className="p-md border-b border-outline-variant">
        ...
        >
          ...
          <span className="font-body-md text-body-md font-medium truncate">
            New Chat
          </span>
        </button>
      </div>
      ...
      <nav className="flex-1 overflow-y-auto px-sm py-sm flex flex-col gap-[2px] custom-scrollbar">
        ...
        >
          ...
          <span className="truncate font-body-md text-[15px] flex-1">
        ...
        {isConversationsExpanded && (
          <div className="flex flex-col gap-[2px] mt-xs">
            {isLoading ? (
              <div className="px-sm py-xs text-[15px] text-on-surface-variant animate-pulse pl-9">
                Loading...
              </div>
            ) : conversations.length === 0 ? (
              <div className="px-sm py-xs text-[15px] text-on-surface-variant pl-9">
                No recent chats
              </div>
            ) : (
      ...
      <div className="mt-auto flex flex-col gap-xs py-4">
        <a
