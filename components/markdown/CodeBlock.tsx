...
export const CodeBlock = memo(function CodeBlock({ language, value }: CodeBlockProps) {
  ...
  return (
    <div className="relative group my-4 rounded-lg overflow-hidden border border-[#333] bg-[#121212] font-code-sm">
      <div className="flex items-center justify-between px-4 py-2 bg-[#1a1a1a] border-b border-[#333] text-xs text-[#a0a0a0] font-sans">
      ...
      <div className="p-4 overflow-x-auto custom-scrollbar text-[13px] leading-relaxed">
        {html ? (
          <div dangerouslySetInnerHTML={{ __html: html }} className="[&>pre]:!bg-transparent [&>pre]:!m-0 [&>pre]:!p-0" />
        ) : (
